      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <ol className="relative border-l border-gray-300">
            <li className="mb-10 ml-8">
              ...
              <p className="text-base font-normal text-gray-600">
                Recebemos e confirmamos todas as especificações técnicas da sua
                unidade.
              </p>
            </li>
            <li className="mb-10 ml-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <button className="mt-6 w-full flex justify-center cursor-pointer items-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue transition-colors">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
